...
func Test_canPlaceFlowersV5(t *testing.T) {
	type args struct {
		flowerbed []int
		n         int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := canPlaceFlowersV5(tt.args.flowerbed, tt.args.n); got != tt.want {
				t.Errorf("canPlaceFlowersV5() = %v, want %v", got, tt.want)
			}
		})
	}
}
