...
func Test_canPlaceFlowersV3(t *testing.T) {
	type args struct {
		flowerbed []int
		n         int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := canPlaceFlowersV3(tt.args.flowerbed, tt.args.n); got != tt.want {
				t.Errorf("canPlaceFlowersV3() = %v, want %v", got, tt.want)
			}
		})
	}
}
