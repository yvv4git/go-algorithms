...
func Test_shortestDistanceV2(t *testing.T) {
	type args struct {
		wordsDict []string
		word1     string
		word2     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := shortestDistanceV2(tt.args.wordsDict, tt.args.word1, tt.args.word2); got != tt.want {
				t.Errorf("shortestDistanceV2() = %v, want %v", got, tt.want)
			}
		})
	}
}
