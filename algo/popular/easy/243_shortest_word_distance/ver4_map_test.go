...
func Test_shortestDistanceV4(t *testing.T) {
	type args struct {
		wordsDict []string
		word1     string
		word2     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := shortestDistanceV4(tt.args.wordsDict, tt.args.word1, tt.args.word2); got != tt.want {
				t.Errorf("shortestDistanceV4() = %v, want %v", got, tt.want)
			}
		})
	}
}
