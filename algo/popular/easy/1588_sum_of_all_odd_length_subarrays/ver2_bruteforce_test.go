...
func Test_sumOddLengthSubarraysV2(t *testing.T) {
	type args struct {
		arr []int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := sumOddLengthSubarraysV2(tt.args.arr); got != tt.want {
				t.Errorf("sumOddLengthSubarraysV2() = %v, want %v", got, tt.want)
			}
		})
	}
}
