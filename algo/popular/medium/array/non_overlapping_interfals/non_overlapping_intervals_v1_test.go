...
func Test_eraseOverlapIntervalsV1(t *testing.T) {
	type args struct {
		intervals [][]int
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := eraseOverlapIntervalsV1(tt.args.intervals); got != tt.want {
				t.Errorf("eraseOverlapIntervalsV1() = %v, want %v", got, tt.want)
			}
		})
	}
}
