...
func knapsack(weights []int, values []int, capacity int) int {
	/*
		TASK: Дано N предметов с весом w_i и ценностью v_i. Вместимость рюкзака W.
		Нужно максимизировать суммарную ценность предметов в рюкзаке (0/1 Knapsack).
		...
		NOTE: Встроенная max() доступна с Go 1.21.
	*/
